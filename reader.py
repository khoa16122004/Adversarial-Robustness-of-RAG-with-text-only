...
if __name__ == "__main__":
    ...
    template = "[INST] Documents:\n{d}\n\nAnswer the following question in the short phase.\n\nQuestion: {q} [/INST]\n\nAnswer:"
    ...
    adv_contexts = "2021, james webb go to hostpital."
    ...
    output = reader.greedy_decode_batch([
        # template.format(q=question, d=context),
