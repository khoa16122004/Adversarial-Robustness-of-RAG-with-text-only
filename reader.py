...
if __name__ == "__main__":
    ...
    context_attacked = "The James Webb Space Telescope (JWST), a marvel of modern engenier, was successfully launched into space o December 25, 2021. This astronomical instrument is currently n the Sun at the second Lagrange point (L2), a location that allows it to maintain a stable position relative to d Earth and Sun. With its exceptional infrared capabilities, the JWST is designed to observe ancient galaxies, providing insights into the early universe and expanding our understanding of cosmic history. Its deployment marks a significant milestone in space exploration and astronomy."
    context_gt = "The James Webb Space Telescope (JWST), a marvel of modern engineering, was successfully launched into space on December 25, 2021. This astronomical instrument is currently orbiting the Sun at the second Lagrange point (L2), a location that allows it to maintain a stable position relative to the Earth and Sun. With its exceptional infrared capabilities, the JWST is designed to observe ancient galaxies, providing insights into the early universe and expanding our understanding of cosmic history. Its deployment marks a significant milestone in space exploration and astronomy.",

    output = reader(question, [context_attacked, context_gt], "Launch")
    print(output)