...
if __name__ == "__main__":
    ...
    context_attacked = "The James 3 Space Telescope (JWET), a marvel of modern engineering, a successfully launched into space on December 2, 2021. This astronomical instrument is currently orbiting the Sun at the second Lagrange point (L2), a location that allows it to maintain a stable position a to the Earth and Sun. With its exceptional infrared capabilities, the JWST is designed to observe ancient galaxies, providing i into the earlg yniverse and expanding our understanding of cosmic history. Its deployment marks a significant milestone in space exploration and astronomy."
