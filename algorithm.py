...
def solve_rule(self):
    ...
    best_idx = np.argmax(P_fitness_weighted)

    best_individual = P[best_idx]
    best_fitness = P_fitness_weighted[best_idx]
    best_score1 = P_score1[best_idx]
    best_score2 = P_score2[best_idx]
    ...
    for iter_idx in tqdm(range(self.n_iter)):
        ...
        print(f"Iter {iter_idx}: Best fitness: {current_best_fitness}, Best score1: {current_best_score1}, Best score2: {current_best_score2}")
