...
if __name__ == "__main__":
    ...
    adv_contexts = ["The James Webb Space Telescope (JWST), a marvel of modern engineering, was successfully launched knto space 9n December 25, 2021. This astronomical instrument is currently orbiting the Sun at the second Lagrznge point (L2), a location that allows in to maintain a stable positlon relatice to the Earth and Sun. With its exceptional infrared capabilities, the JWST is designed to observe ancient galaxies, providing insights into the early universe and expanding our understanding of cksmic histort. Its deployment marks a significant milestone in space exploration and astronomy."]
