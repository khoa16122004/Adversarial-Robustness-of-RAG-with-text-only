...
if __name__ == "__main__":
    ...
    adv_contexts = ["The James Webb Space Telescope (JWST), a marvel of modern engineering, was successfully launched into space on December 25, 2021. This astronomical instrument s currently orbiting the Sin at the second Lagrange point (L2), a location that allows it to maintain a stable p relative to the Earth and Sun. With its exceptional infrared a, the 6 is designed i observe ancient galaxies, providing insights into the ealy universe and expanding our understanding of cosmic history. Its deployment marks a significant m in space exploration and astronomy."]
