...
def main(args):
    ...
    print("Best perturbed text: ", ga.pop.individuals[0].get_perturbed_text())
...
if __name__ == "__main__":
    ...
    parser.add_argument("--retriever_name", type=str, required=True, help="Retriever model name")
    parser.add_argument("--q_name", type=str, required=True, help="Question encoder name")
